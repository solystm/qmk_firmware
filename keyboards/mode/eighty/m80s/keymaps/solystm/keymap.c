 ...
 */
  [_BASE] = LAYOUT_eighty_m80s(
    ...
    MC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,    MO(1),                          KC_UP,
 ...
 */
  [_FN1] = LAYOUT_eighty_m80s(
    ...
    _______, _______, _______,   _______, _______, _______, _______, KC_ENT,  KC_HOME, KC_END,  _______, _______, _______,                              _______,
 ...
 */
  [_VIM1] = LAYOUT_eighty_m80s(
    ...
    XXXXXXX, VIM_1,   VIM_2,   VIM_3,   VIM_4,   VIM_5,   VIM_6,   VIM_7,   VIM_8,   VIM_9,   VIM_0,   XXXXXXX, XXXXXXX, XXXXXXX,            KC_INS,  KC_HOME, KC_PGUP,
    ...
    V_SHFT,  XXXXXXX, VIM_X,   VIM_C,   VIM_V,   VIM_B,   VIM_N,   VIM_M,   XXXXXXX, VIM_DOT, V_SLASH,          V_SHFT,  XXXXXXX,                     KC_UP,
